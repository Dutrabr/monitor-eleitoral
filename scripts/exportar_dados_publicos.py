...
destinada a redistribuicao publica). O site publico so' precisa de 4
coisas, todas ja' evidencia confirmada ou publica por natureza:
...
def main() -> int:
    _limpar_e_copiar(["candidatos", "planos_de_governo", "planos_curados", "transcricoes"])
    ...
    print(f"candidatos: {n_candidatos}")
    print(f"planos de governo (PDF): {n_planos}")
    print(f"planos curados: {n_curados}")
